setwd("/Users/Selv/Desktop/Coursera/Getting and Cleaning Data/Project/UCI HAR Dataset")
...
# read in features
varNames <- read.table("features.txt", col.names = c("n","functions"))
dim(varNames)

# read training data
x.train <- read.table("train/X_train.txt", col.names = varNames$functions)
y.train <- read.table("train/Y_train.txt", col.names = "code")
subj.train <- read.table("train/subject_train.txt", col.names = "subject")

# read testing data
x.test <- read.table("test/X_test.txt", col.names = varNames$functions)
y.test <- read.table("test/Y_test.txt", col.names = "code")
